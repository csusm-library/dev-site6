<div id="library-header-wrapper" class="navbar navbar-fixed-top">
        ...
        <ul class="nav pull-left" id="main-menu-left">
          ...
          <li id="services-menu" class="dropdown">
            ...
            <ul class="dropdown-menu" id="services-dropdown">
              ...
              <li><a href="https://lib2.csusm.edu/subject-guide/193-CSUSM-ETD-Submission-Guide">E-Thesis, Project, and Dissertation Submission</a></li>
          ...
          <li id="about-menu" class="dropdown">
            ...
            <ul class="dropdown-menu" id="about-dropdown">
              ...
              <li><a href="/external/about-the-library/rooms-the-kellogg-library" title="Rooms in the Kellogg Library">Rooms in Kellogg Library</a></li>
